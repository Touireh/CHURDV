    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">les abscences</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
<!----------------------------------------------------------------------------------------------------------------->
    <section class="section dashboard">
          <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Liste Noir <span>| Abscence</span></h5>

                  <table class="table datatable-boardless">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                        ...
                        <th scope="col">accepter_justif</th>
