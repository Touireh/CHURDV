...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="rindex.php">
      ...
      <li class="nav-item">
          <a class="nav-link " href="secretaire-profile.php">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic"> Je suis un secretaire-utilisateur de l'application des rendez-vous en ligne CHUeRDV
                  .</p>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">date_naissance</div>
                  ...
                  <?php include_once RACINE.'/beans/Service.php';
                        include_once RACINE.'/services/ServiceService.php';
                        $es = new ServiceService();
                        $em = $es->findById($_SESSION['service']);?>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">departement</div>
                    <div class="col-lg-9 col-md-8"><?php echo $em->getLibelle();?></div>
                  </div>
    </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="controller/updateSecretaire.php">
                    <div class="row mb-3">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <div id="ind"></div>
                    ...
                    <div class="text-center">
                        <input type="button" class="btn btn-primary" value="Valider" id="edit"/>
