...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center" style="width: 100%;height: 90vh;background: url('../../asset/img/hopital.jpg') top center;background-size: cover;margin-bottom: -200px;">
    <div class="container">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Spécalité</h2>
          <p>Clicker sur le nom du specialité qui vous convient.</p>
        </div>
