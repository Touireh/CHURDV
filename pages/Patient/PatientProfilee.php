          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">Absence</button>
                </li>
              </ul>
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form  method="post" action="modifypswrd.php">
                ...
                <?php
                  ...
                  ?>
                      <tr>
                          ...
                          <td><a href="fpdf184/bnrdv.php?id=<?php echo $e->id; ?>">Telecharger</a></td>
...
<script src="../../vendor/jquery/jquery.min.js"></script>
    ...
    <script src="../../script/edit.js?v=2"></script>
