...
class AdminService implements IDao {
    ...
    public function findById($id) {
        ...
        $admin = new Admin($res->id, $res->cin, $res->nom, $res->prenom, $res->telephone, $res->date_naissance, $res->photo, $res->id_user);
        return $admin;
    }
    ...
    public function findByIdUser($id_user) {
        ...
        $res = $req->fetch(PDO::FETCH_OBJ);
        $admin = new Admin($res->id, $res->nom, $res->prenom, $res->cin, $res->date_naissance, $res->telephone,$res->id_user, $res->photo);
        return $admin;
    }
