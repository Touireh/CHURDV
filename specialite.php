    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ajouter specialite</h5>
              ...
              <form action="#" method="post" role="form" class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select" aria-label="Default select example" id="service"  ></select>
                </div>
      ...
      <div class="card">
            <div class="card-body">
              <h5 class="card-title">specialite</h5>
