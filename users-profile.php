...
if ($_SESSION["user"]) {
    if ($_SESSION['role'] == "secretaire" || $_SESSION['role'] == "admin") {
...
<body>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="img/<?php echo $t->getPhoto();?>" alt="Profile" class="rounded-circle">
              <h2><?php echo $t->getNom().' '.$t->getPrenom();?></h2>
              <h3>Patient</h3>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Historique</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">Je suis un utilisateur de l'application des rendez-vous en ligne MAYDOC .</p>

                  <h5 class="card-title">Profile Details</h5>

                  <div class="row">
                      <input id="id" value="<?php echo $t->getId();?>" hidden>
                    <div class="col-lg-3 col-md-4 label ">Full Name</div>
                    <div class="col-lg-9 col-md-8"><?php echo $t->getNom().' '.$t->getPrenom();?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Cin</div>
                    <div class="col-lg-9 col-md-8"><?php echo $t->getCin();?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Date de Naissance</div>
                    <div class="col-lg-9 col-md-8"><?php echo $t->getDateNaissance();?></div>
                  </div>
                  
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Telephone</div>
                    <div class="col-lg-9 col-md-8"><?php echo $t->getTelephone();?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Adresse</div>
                    <div class="col-lg-9 col-md-8"><?php echo $t->getAdresse();?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?php echo $b->getEmail();?></div>
                  </div>
                  ...
                  <table class="table table-borderless table-hover" >
                     <thead style="background-color: #02ffa8">
                       <tr>
                         ...
                         <th class="text-primary" scope="col">date-time</th>
                         <th class="text-primary" scope="col">patient</th>
                         <th class="text-primary" scope="col">secretaire</th>
  ...
  <script src="script/users-profile.js"></script>
