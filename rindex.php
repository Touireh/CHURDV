    ...
    <section class="section dashboard">
          <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Liste rendez-vous <span>| Aujourd’hui</span></h5>
                  ...
                  <table class="table table-borderless">
                    <thead >
                      <tr>
                        ...
                        <th class="text-primary" scope="col">present</th>
                        <th class="text-primary" scope="col">abscent</th>
                        <th class="text-primary" scope="col">info</th>
                      </tr>
                    </thead>
                    <tbody id="today">
