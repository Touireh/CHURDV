...
if ($op != '') {
    if ($op == 'add') {
        /*$es->create(new RendezVous(0, 'OOOO-00-00','00:00:00', 'Dr.', $patient, $service, $specialite, 'en_attente', $fiche));*/
        $sub = "Prendre rendez-vous";
        //the message
        $msg = "Bonjour, Validez votre demande de randez-vous cliquant sur le lien ci-dessous : \n\n http://localhost/projetCHU/controller/createRendezVous.php?&patient=$patient&service=$service&specialite=$specialite&fiche=$fiche";
