...
if($msg != 'non indentique'){
    $es->create(new User(1,$email,md5($password),'secretaire'));
    header("Location: CreateSecretaire.php?email=$email&nom=$nom&prenom=$prenom&datenaissance=$date_naissance&cin=$cin&photo=$photo&service=$service&specialite=$specialite&tele=$tele&time=$time");
}else{
