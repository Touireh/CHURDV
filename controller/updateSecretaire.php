...
if($photo != ''){
$query = "UPDATE `secretaire` SET `nom` = '$nom', `prenom` = '$prenom', `cin` = '$cin', `telephone` = '$telephone', `id_user` = '$id_user', `date_naissance` = '$date_naissance', `photo` = '$photo' WHERE `id` = $id ";
}else{
    $query = "UPDATE `secretaire` SET `nom` = '$nom', `prenom` = '$prenom', `cin` = '$cin', `telephone` = '$telephone', `id_user` = '$id_user', `date_naissance` = '$date_naissance' WHERE `id` = $id ";
}
...
header("location: ../secretaire-profile.php");
