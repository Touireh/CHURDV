...
<body class="login">
    <form action="" method="post">
        ...
        <button type="submit" class="btn ana" style="border: 3px solid #1977cc;" name="btn_submit" value="Sign in">se connecter </button>
        <a href="register.php" style="color: #1977cc;">Créer un compte </a>
        <br>
        <br>
        <a href="index.php" style="color: #1977cc;">Revenir à la page d'acceuil </a>
        </div>
    </form>
</body>
