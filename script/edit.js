$(document).ready(function () {
    ...
    $(document).on('click', '.justifier', function () {
        ...
        console.log(_cin);
        var ligne = '<div class="form-group mt-3"><textarea id="area" class="form-control" name="message" rows="5" placeholder="Message (Justification d\'abscence)"></textarea><div class="validate"></div><div class="text-center"><button type="button" class="btn btn-outline-primary envoyer" style="margin-top:2%;">Envoyer</button></div></div>';
            ...
            if(newPassword.length != 0 ){
                ...
                $('#edit').click(function () {
                    ...
                    $.ajax({
                        ...
                        data: {op: 'update', id: idUser, password:newPassword, email: 'ff', role:'patient', realpassword:realPassword, currentPassword:currentPassword},
                        type: 'POST',
                        success: function (data, textStatus, jqXHR) {
                            console.log(textStatus);
                            console.log(data);
