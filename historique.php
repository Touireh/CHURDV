...
<body>
  ...
  <tbody>
      ...
      if (!$con){ // Contrôler la connexion
          ...
          $sql= " select r.*, p.nom as 'npatient', p.prenom as 'ppatient' from `rendez-vous` r  inner join patient p on r.patient = p.id";
          ...
          if($result){
            while($row=mysqli_fetch_assoc($result)){
              ...
              <td>'.$fiche.'</td>
              <td>
              <button class=" btn btn-primary"><a href="update.php?id='.$id.'" class="text-light">Traiter </a> </button>
     ...
     ?>
            ...
            <!-- Recent Sales -->
                ...
                <div class="card-body">
                  <h5 class="card-title">Historique <span>| rendez-vous</span></h5>
